package com.techullurgy.codehorn.c.execution.controllers
...
@RestController
@RequestMapping(EndpointConstants.Public.LanguageExecution.POST_CODE_EXECUTION_C)
class CExecutionController {
    ...
    fun executeCCode(
        ...
        val results = UserFileCreator(request.submissionId, "c").use {
